...
def chat_with_open_ai():
    ...
    # Prompt the user to select their preferred input method
    input_method = input("Select your preferred input method: (1) Text, (2) Speech: ")

    # Determine the input source based on the user's choice
    if input_method == "1":
        input_source = "text"
    elif input_method == "2":
        input_source = "speech"
    ...
    while True:
        if input_source == "text":
            ...
            try:
                ...
                # If input is 'Stop' or 'Exit', end the conversation.
                if user_input.lower() == "stop" or user_input.lower() == "exit":
                    print("Conversation ended.")
                    break

                # Send user input to Azure OpenAI and listen for the response.
                response.append({"role":"user","content":"" + user_input + ""})
