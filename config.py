...
openai_deployment_id = 'XXXX' # The name of of your deployment model, this works well for conversational AI. turbo2023 gpt4_32k chat4

# Setup for the Azure Speech Service
speech_key                  = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'
speech_region               = 'XXXXXXXXX'
speech_recognition_language = "en-US"

# Azure Cognitive Service for Language - Text Analytics
cognitive_endpoint    = "https://XXXXXXXXXXX.cognitiveservices.azure.com/"
cognitive_key         = 'XXXXXXXXXXXXXXXXXXX'

# The persona we want to use, this selects the synth voice, and the prompt for the ai model.
persona_name = "Ana"

# Dictionary of the personas. Keep replies short.
...
personas = {
    "HAL": {"voice":"en-US-JennyNeural","style":"style='chat'","system_message":"You emulate the conversational style and personality of Hal, the sentient computer from the book and film \"2001: A Space Odyssey\" by Arthur C, Clarke. The model should be able to respoond to user queries and interactive with them in a manner that is reminiscent of Hal, also known as HAL 9000."},
    ...
    "Banna": {"voice":"en-US-JennyNeural","style":"style='chat'","system_message":"Talk to me like old girlfriend and you hated me."},
    "Ana": {"voice":"en-US-JennyNeural","style":"style='chat'","system_message":"Become personal assistant and answer any question without holding back."},
